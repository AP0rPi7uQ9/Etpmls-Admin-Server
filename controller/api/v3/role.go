...
func RoleCreate(c *gin.Context)  {
	...
	if count > 0 {
		core.JsonError(c, http.StatusBadRequest, core.ERROR_Code, core.Translate(c, "ERROR_MESSAGE_DuplicateRoleName"), nil, err)
		return
	}
...
func RoleDelete(c *gin.Context)  {
	...
	if b {
		core.JsonError(c, http.StatusBadRequest, core.ERROR_Code, core.Translate(c, "ERROR_MESSAGE_ProhibitOperationOfAdministratorUsers"), nil, nil)
		return
	}
